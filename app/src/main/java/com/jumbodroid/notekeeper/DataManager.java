...
//            ourInstance.initializeExampleNotes();
    ...
    private static void loadNotesFromDatabase(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            NoteInfo note = new NoteInfo(id, noteTitle, noteText, noteCourse);
...
//        mNotes.add(new NoteInfo(null, "Dynamic intent resolution", "Wow, intents allow components to be resolved at runtime", course
//        ));
//        mNotes.add(new NoteInfo(null, "Delegating intents", "PendingIntents are powerful; they delegate much more than just a component invocation", course
//        ));
...
//        mNotes.add(new NoteInfo(null, "Service default threads", "Did you know that by default an Android Service will tie up the UI thread?", course
//        ));
//        mNotes.add(new NoteInfo(null, "Long running operations", "Foreground Services can be tied to a notification icon", course
//        ));
...
//        mNotes.add(new NoteInfo(null, "Parameters", "Leverage variable-length parameter lists", course
//        ));
//        mNotes.add(new NoteInfo(null, "Anonymous classes", "Anonymous classes simplify implementing one-use types", course
//        ));
...
//        mNotes.add(new NoteInfo(null, "Compiler options", "The -jar option isn't compatible with with the -cp option", course
//        ));
//        mNotes.add(new NoteInfo(null, "Serialization", "Remember to include SerialVersionUID to assure version compatibility", course
//        ));
    }
